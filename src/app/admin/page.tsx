...
export default function AdminPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {message && (
        <div className="bg-primary/10 text-primary-light rounded-lg px-4 py-2 text-sm">
          {message}
        </div>
      )}
                    ...
                    {editingId === p.id ? (
                      ...
                      <>
                        <td className="px-4 py-2 font-medium">
                          {p.name}
                          {p.is_admin === 1 && <span className="ml-1 text-[10px] bg-primary/10 text-primary px-1 rounded">Admin</span>}
                        </td>

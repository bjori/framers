...
export function TournamentStandings({ standings, isDoubles = false }: { standings: Standing[]; isDoubles?: boolean }) {
  return (
    <section>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-slate-50 dark:bg-slate-800/50">
                ...
                <th className="text-left py-2.5 px-3 font-semibold">{isDoubles ? "Team" : "Player"}</th>
